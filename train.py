...
from utils.train_utils import get_dir_name, format_metrics, get_dir_name_for_hyperparameter_search
...
def train(args):
        ...
        with torch.no_grad():
            if (epoch + 1) % args.eval_freq == 0:
                ...
                if model.has_improved(best_val_metrics, val_metrics):
                    ...
                    logging.info(" ".join([
                        'Model Improved; Epoch Test Metrics: {:04d}'.format(epoch + 1),
    ...
    logging.info("Last Epoch: {:04d}".format(epoch + 1))
